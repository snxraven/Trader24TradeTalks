      ...
      db.collection("users")
        ...
        .onSnapshot(
          function(doc) {
            if (typeof doc.data() !== "undefined" && this._isMounted) {
              this.setState({
                cryptoFunds: `$${this.numberWithCommas(
                  Number(doc.data()["cryptoFunds"])
                )}`,
                fundsLoader: true
              });
              admin = doc.data()["admin"];
        ...
        <div className="topbar">
          ...
          <div className="topbar__container">
            <div className="topbar__user">
              ...
              <span className = "topbar__name"> {user + "\n\nUID: " + userID} < /span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              {this.state.fundsLoader === true && (
                <div className="topbar__power">
                  ...
                  <h3>Crypto:{this.state.cryptoFunds}</h3>
                </div>
              )}
